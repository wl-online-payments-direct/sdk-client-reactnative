...
describe('UrlUtil', () => {
  ...
  describe('objectToQueryString', () => {
    ...
    it('should filter out undefined and empty-string values but keep 0', () => {
  ...
  describe('urlWithQueryString', () => {
    ...
    it('should construct URL with path and query string', () => {
      const result = UrlUtil.urlWithQueryString(
    ...
    it('should filter out undefined and empty values but keep 0 in query string', () => {
      const result = UrlUtil.urlWithQueryString('https://example.com', {
        a: 1,
        b: undefined,
        c: '',
