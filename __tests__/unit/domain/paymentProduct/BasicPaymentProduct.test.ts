...
beforeEach(() => {
  basicPaymentProduct =
    new DefaultPaymentProductFactory().createBasicPaymentProduct(
...
describe('paymentProductSpecificData', () => {
  it('should not be undefined: `paymentProductSpecific302Data`', () => {
    const paymentProduct302SpecificData =
      basicPaymentProduct.paymentProduct302SpecificData;

    expect(paymentProduct302SpecificData).toBeDefined();
    expect(paymentProduct302SpecificData?.networks).toEqual([
      'test network 1',
      'test network 2',
      'test network 3',
    ]);
