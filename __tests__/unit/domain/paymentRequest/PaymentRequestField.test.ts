...
import { PaymentProductField, PaymentRequestField } from '../../../../src';
...
beforeEach(() => {
  paymentProductField =
    new DefaultPaymentProductFactory().createPaymentProductField(
...
describe('getMaskedValue', () => {
  it('should return masked value', () => {
    ...
    expect(paymentRequestField.getMaskedValue()).toBe(
