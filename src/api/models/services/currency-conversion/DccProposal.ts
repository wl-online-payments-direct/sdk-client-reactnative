...
export interface DccProposal {
  readonly baseAmount: AmountOfMoney;
  readonly targetAmount: AmountOfMoney;
  readonly rate: RateDetails;
  readonly disclaimerReceipt?: string;
  readonly disclaimerDisplay?: string;
}
