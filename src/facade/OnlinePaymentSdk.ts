...
export class OnlinePaymentSdk {
  ...
  getPaymentProduct(
    ...
    return this.paymentProductService.getPaymentProduct(
      paymentProductId,
      paymentContext
    );
  }
  ...
  getPaymentProductNetworks(
    ...
    return this.paymentProductService.getPaymentProductNetworks(
      paymentProductId,
      paymentContext
    );
  }
  ...
  getSurchargeCalculation(
    ...
    return this.clientService.getSurchargeCalculation(
      amountOfMoney,
      cardOrToken
    );
  }
  ...
  getCurrencyConversionQuote(
    ...
    return this.clientService.getCurrencyConversionQuote(
      amountOfMoney,
      cardOrToken
    );
  }
  ...
  getIinDetails(
    ...
    return this.clientService.getIinDetails(
