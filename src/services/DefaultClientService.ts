...
export class DefaultClientService extends BaseService implements ClientService {
  ...
  async getIinDetails(
    ...
    const response = await this.apiClient.post<IinDetailsResponse>(
  ...
  async getSurchargeCalculation(
    ...
    const response = await this.apiClient.post<SurchargeCalculationResponse>(
    ...
    this.validateResponse(
      response,
      'Error while trying to fetch surcharge calculations.'
    );

    this.cacheManager.set<SurchargeCalculationResponse>(
      cacheKey,
      response.data
    );
  ...
  async getCurrencyConversionQuote(
    ...
    this.validateResponse(
      response,
      'Error while trying to fetch currency conversion.'
    );
  ...
  private formatPartialCreditCardNumber(
    partialCreditCardNumber: string
  ): string {
